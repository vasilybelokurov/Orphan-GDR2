...
\caption{The background subtracted Hess diagram from DECALS data. The stars 
were selected based on proper motion from Gaia and proximity to the stream 
track shown on Fig.XX.
}\end{figure}

\begin{figure}
\includegraphics{gaia_cmd.pdf}
\caption{The Gaia based background subtracted Hess diagrams of the nothern and souther parts of the stream.}
\end{figure}
